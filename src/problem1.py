...
def problem1(square, thickness, window):
    ...
    x=point.x
    y=point.y
    start=rg.Point(x-square.length_of_each_side/2,y)
    end=rg.Point(x,y+square.length_of_each_side)

    center=end
    circle=rg.Circle(end,square.length_of_each_side/2)
    circle.attach_to(window)
    circle.fill_color=square.fill_color
    circle.outline_thickness=thickness

    L = rg.Line(start, end)
    L.color = square.outline_color
